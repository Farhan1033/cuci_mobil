...
List<CarWash> CarWash_List = [
  CarWash(
      ...
      about:
          " About is a term commonly used to provide information regarding a specific subject, entity, or person. This section typically encompasses various aspects such as history, purpose, mission, and values, offering a comprehensive overview to the reader. The concept of an section has evolved alongside the development of communication mediums. From the early days of printed books and pamphlets to the modern era of digital websites and social media profiles, the essence remains the same: to inform and introduce. Historically, this section was crucial in academic texts, providing context and background to enhance understanding.",
      imgUrl:
